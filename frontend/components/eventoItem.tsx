  ...
  return (
    <Pressable onPress={() => onEditPress(evento)} style={styles.cardContainer}>
      ...
      <View style={styles.secondaryInfo}>
        ...
        {/* Optionally display Gerador ID */}
        {/* <Text style={styles.label}>Gerador ID:</Text>
        <Text style={styles.value}>{evento.id_gerador}</Text> */}
      </View>
      ...
      {/* <Pressable onPress={() => onEditPress(evento)} style={styles.editButton}>
       ...
       {/* Or keep it simple like GeradorItem */}
       <MaterialCommunityIcons name="chevron-right" size={28} color="#A0AEC0" style={styles.chevron}/>
...
const styles = StyleSheet.create({
  ...
  secondaryInfo: {
    // Styles for the secondary details section
  },
  label: {
    fontSize: 12,
    color: '#A0AEC0', 
